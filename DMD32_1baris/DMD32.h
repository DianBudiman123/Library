...
#define PIN_DMD_nOE		33 		// D22 active low Output Enable, setting this low lights all the LEDs in the selected rows. Can pwm it at very high frequency for brightness control	.
#define PIN_DMD_A		13		// D19
#define PIN_DMD_B		32		// D21
#define PIN_DMD_CLK		18		// D18_SCK  is SPI Clock if SPI is used
#define PIN_DMD_CLK2	26		// D18_SCK  is SPI Clock if SPI is used
